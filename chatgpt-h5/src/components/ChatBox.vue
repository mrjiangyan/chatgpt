<template>
  <div class="container">
      ...
      <div ref="content">
        ...
        <div v-for="(message, index) in messages" :key="index">
          ...
          >
            ...
            <div class="message-cell-content" :style="{justifyContent: message.direction === 'received' ? 'flex-start' : 'flex-end' }">

              <van-button class="message-content" type="default" size="small" round v-html="transformSpecialChars(message.text)" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer">
      <van-field v-model="typingText" placeholder="输入内容" border @keyup.enter="sendText">
        <template #button>
          <van-image class="button" :src="chatImg" @click.enter="sendText" />
        </template>
      </van-field>
    </div>
  </div>
